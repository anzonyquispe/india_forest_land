...
result <- tryCatch({
  ...
  filename <- paste0( "union_states_any_block.RDS")
  ...
  filename <- paste0( "union_states_sum_any_block.RDS" )
  path <- file.path("E_Estimates/_vcf_10_augsyth/group_states", filename)
  ...
  n_df <- df2_union[t2ev_ror_data_entry_block_any %in% est_df$Time][, .N, by = t2ev_ror_data_entry_block_any]
  ...
  filename <- paste0( "union_states_plot_any_block.png")
...
result <- tryCatch({
  ...
  filename <- paste0( "north_states_any_block.RDS")
  path <- file.path("E_Estimates/_vcf_10_augsyth/group_states", filename)
  saveRDS( ppool_syn, path )
  ...
  # Get Summary result
  ppool_syn_time_summ <- summary( ppool_syn )
  filename <- paste0( "north_states_sum_any_block.RDS")
  path <- file.path("E_Estimates/_vcf_10_augsyth/group_states", filename)
  saveRDS( ppool_syn_time_summ,  path )
  ...
  n_df <- df2_north[t2ev_ror_data_entry_block_any %in% est_df$Time][, .N, by = t2ev_ror_data_entry_block_any]
  n_df$Time <- n_df$t2ev_ror_data_entry_block_any
  setorder(n_df,Time )
  setorder(est_df,Time )
  ...
  filename <- paste0( "north_states_plot_any_block.png")
  path <- file.path("F_Figures/_vcf_10_augsyth/group_states", filename)
  ggsave(filename = path, plot = p, width = 6, height = 4, dpi = 300)
...
result <- tryCatch({
  ...
  filename <- paste0( "rest_states_any_block.RDS")
  path <- file.path("E_Estimates/_vcf_10_augsyth/group_states", filename)
  saveRDS( ppool_syn, path )
  ...
  # Get Summary result
  ppool_syn_time_summ <- summary( ppool_syn )
  filename <- paste0( "rest_states_sum_any_block.RDS")
  path <- file.path("E_Estimates/_vcf_10_augsyth/group_states", filename)
  saveRDS( ppool_syn_time_summ,  path )
  ...
  n_df <- df2_rest[t2ev_ror_data_entry_block_any %in% est_df$Time][, .N, by = t2ev_ror_data_entry_block_any]
  n_df$Time <- n_df$t2ev_ror_data_entry_block_any
  setorder(n_df,Time )
  setorder(est_df,Time )
  ...
  filename <- paste0( "rest_states_plot_any_block.png")
  path <- file.path("F_Figures/_vcf_10_augsyth/group_states", filename)
  ggsave(filename = path, plot = p, width = 6, height = 4, dpi = 300)
