...
filename <- paste0( "avobe_median_all_block_any.RDS")
...
filename <- paste0( "avobe_median_all_sum_block_any.RDS")
path <- file.path("E_Estimates/_vcf_10_augsyth/median_filter", filename)
...
n_df <- df2_avobe[t2ev_ror_data_entry_block_any %in% est_df$Time][, .N, by = t2ev_ror_data_entry_block_any]
...
filename <- paste0( "avobe_median_all_plot_block_any.png")
...
filename <- paste0( "below_median_all_block_any.RDS")
path <- file.path("E_Estimates/_vcf_10_augsyth/median_filter", filename)
saveRDS( ppool_syn, path )
...
# Get Summary result
ppool_syn_time_summ <- summary( ppool_syn )
filename <- paste0( "below_median_all_sum_block_any.RDS")
path <- file.path("E_Estimates/_vcf_10_augsyth/median_filter", filename)
saveRDS( ppool_syn_time_summ,  path )
...
filename <- paste0( "below_median_all_plot_block_any.png")
path <- file.path("F_Figures/_vcf_10_augsyth/state", filename)
ggsave(filename = path, plot = p, width = 6, height = 4, dpi = 300)
