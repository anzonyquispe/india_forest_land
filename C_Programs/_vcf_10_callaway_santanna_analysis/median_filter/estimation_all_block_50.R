...
filename <- paste0( "bellow_median_block_50.RDS")
...
p <- ggplot(est_df, aes(x = Time, y = Estimate)) + 
  ...
  ggtitle( "Ror Data Entry at Block Level with more \n than 50% of Villages Treated (Below Median)" ) +
  theme_minimal()

filename <- paste0( "below_median_block_50.png")
